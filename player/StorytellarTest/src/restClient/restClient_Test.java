...
public class restClient_Test extends TestCase {
	...
	@Test
	public void test_getAvailableStoriesWithParamenter_testxsd_revision() {
		client = new RESTClient();
		String url = URLallStories + "?revision=6";
		try {
			JSONArray toTest = client.getAvailableStoriesWithParamenter(url);
			if (toTest.length() != 0) {
				fail("Number of Stories is wrong! expected: " + 0
						+ ", actual: " + toTest.length());
			}
	...
	@Test
	public void test_getAvailableStoriesWithParamenter_testSize() {
		fail("Not yet implemented!");
	}

	@Test
	public void test_getAvailableStoriesWithParamenter_testSize_uom() {
		fail("Not yet implemented!");
	}
	...
	@Test
	public void test_getAvailableStoriesWithParamenter_testRadius_uom() {
		fail("Not yet implemented!");
	}
	...
	@Test
	public void test_getAvailableStoriesWithParamenter_testUpdated_at() {
		fail("Not yet implemented!");
	}
