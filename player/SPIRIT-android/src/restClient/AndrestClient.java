...
public class AndrestClient {
	 ...
	 */
	public JSONArray request(String url, String method, Map<String, Object> data) throws RESTException {
	...
	public JSONArray get(String url) throws RESTException {
		...
		try {
			...
			return new JSONArray(readInput(response.getEntity().getContent()));
		} catch (Exception e) {
